...
<div class="answer-content">
點選螢幕上方檔名旁邊的「設定圖示」即可重新編輯專案名稱：<br><img src="./images/image 9.png">
</div>
</details>
...
根據內政部於中華民國 113 年 1 月 1 日生效的「建築物混凝土結構設計規範」，其第十七章「混凝土結構用錨栓」是以美國 ACI 318-19 規範為基礎，並考量了下一版 ACI 318 (ACI 318-25) 的重要內容修訂而成。
此章節適用於結構構件與非屬結構但與安全有關之附掛物的結合，例如消防灑水系統、重型懸吊管或安全欄杆等。規範中明確要求錨栓須符合開裂混凝土要求並能抵抗地震載重，
同時混凝土結構用錨栓的品質試驗方法和合格標準建議參考美國混凝土學會的 ACI 355.2 和 ACI 355.4。
</div>
</details>
...
<details>
<summary>Q: 在地震條件下，錨栓的承載能力與在靜止或非開裂混凝土條件下有何不同？ </summary>
<div class="answer-content">
地震條件下的錨栓試驗（例如根據ACI 355.2/355.4）是在循環載荷、假設混凝土總是開裂、且裂縫寬度較大的情況下進行的6。
這些試驗結果會決定錨栓在地震情況下的拔出拉力和剪力破壞抗力，在地震情況下，錨栓的強度會顯著降低，例如M8錨栓在開裂混凝土地震條件下的拔出抗力遠低於非開裂或開裂靜止條件。
</div>
</details>
